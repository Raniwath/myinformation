            ...
            <div className='below_container' id="below">
                <Row className='below_complete_row'>
                    ...
                    <Col className="quickID_col" sm={12}>
                        ...
                        {/* <Row> <h1> <Below_Info number={{ Phone: '8411068827' }} /> </h1> </Row>

                        <Row> <h1> <Below_Info text={{ Email: 'komalwath301@gmail.com' }} /> </h1> </Row>

                        <Row> <h1> <Below_Info link={{ Skype: 'Komal Wath' }} /> </h1> </Row> */}
                    </Col>
